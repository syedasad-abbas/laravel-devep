                ...
                <div class="call-grid">
                    ...
                    <section class="controls-panel">
                        <div class="panel-card">
                            ...
                            <p>Create a new call or join with an existing code.</p>
                            <div class="input-stack">
                                <label for="dialInput">Dial target</label>
                                <input id="dialInput" type="text" placeholder="+15551234567 or extension">
                            </div>
                            <div class="button-row">
                                <button type="button" class="btn-call button-with-icon" id="startCallBtn">
                                    <span class="icon" aria-hidden="true">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M3 5.25C3 4 4 3 5.25 3h2.5C9 3 10 4 10 5.25v2C10 8.5 9 9.5 7.75 9.5H6.5c.2 2.4 1.2 4.4 3 6.2 1.8 1.8 3.8 2.8 6.2 3v-1.25C15.5 16.25 16.5 15.25 17.75 15.25h2c1.25 0 2.25 1 2.25 2.25v2.5C22 21.75 21 22.75 19.75 22.75 9.1 22.75 3 13.88 3 5.25Z" />
                                        </svg>
                                    </span>
                                    <span>Start call</span>
                                </button>
                                <button type="button" class="btn-hang button-with-icon" id="hangupBtn">
                                    <span class="icon" aria-hidden="true">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M3.4 15c-.9.2-1.53 1.05-1.38 1.96l.42 2.68c.19 1.2 1.35 2.04 2.53 1.78l2.44-.54c.89-.2 1.49-1.04 1.41-1.95l-.19-2.22c2.11-.54 4.34-.54 6.45 0l-.19 2.22c-.08.91.52 1.75 1.41 1.95l2.44.54c1.18.26 2.34-.58 2.53-1.78l.42-2.68c.15-.91-.48-1.76-1.38-1.96-5.22-1.19-10.78-1.19-15.8 0Z" />
                                        </svg>
                                    </span>
                                    <span>End call</span>
                                </button>
                                <button type="button" class="btn-secondary button-with-icon" id="demoCallBtn">
                                    <span class="icon" aria-hidden="true">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M12 5a7 7 0 1 1-7 7 1 1 0 0 0-2 0 9 9 0 1 0 9-9 1 1 0 0 0 0 2Zm-2.293 5.293a1 1 0 0 0-1.414 1.414l2 2a1 1 0 0 0 1.414 0l5-5a1 1 0 0 0-1.414-1.414L11 11.586Z" />
                                        </svg>
                                    </span>
                                    <span>Demo call</span>
                                </button>
                        ...
                        <div class="panel-card">
                            <h3>Call features</h3>
                            <p>Live audio/video controls</p>
                            <div class="action-buttons">
                                <button type="button" class="btn-feature button-with-icon" id="muteBtn">
                                    <span class="icon" aria-hidden="true">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M11 5.5c0-.78-.45-1.48-1.15-1.81a1.9 1.9 0 0 0-2.03.31L4.44 7.12H2.25A1.25 1.25 0 0 0 1 8.37v7.25A1.25 1.25 0 0 0 2.25 16.87h2.19l3.38 3.12a1.9 1.9 0 0 0 2.03.32c.7-.33 1.15-1.03 1.15-1.81V5.5ZM13 8v8.5a3.5 3.5 0 0 0 7 0V8h-2v8.5a1.5 1.5 0 0 1-3 0V8h-2Z" />
                                        </svg>
                                    </span>
                                    <span class="label">Mute mic</span>
                                </button>
                                <button type="button" class="btn-feature button-with-icon active" id="speakerBtn">
                                    <span class="icon" aria-hidden="true">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M4.5 9.5h2.53L10 6.35a1 1 0 0 1 1.7.71v9.88a1 1 0 0 1-1.7.7L7.03 14.5H4.5A1.5 1.5 0 0 1 3 13v-2a1.5 1.5 0 0 1 1.5-1.5Zm12.02-5.86a1 1 0 0 1 1.41.09A9 9 0 0 1 20.5 10a9 9 0 0 1-2.57 6.27 1 1 0 1 1-1.46-1.37A7 7 0 0 0 18.5 10a7 7 0 0 0-2.03-4.9 1 1 0 0 1 .05-1.46Zm-2.83 2.83a1 1 0 0 1 1.41.1A5 5 0 0 1 16.5 10a5 5 0 0 1-1.4 3.42 1 1 0 0 1-1.46-1.38 3 3 0 0 0 0-4.08 1 1 0 0 1 .05-1.46Z" />
                                        </svg>
                                    </span>
                                    <span class="label">Speaker on</span>
                                </button>
                                <button type="button" class="btn-feature button-with-icon" id="recordBtn">
                                    <span class="icon" aria-hidden="true">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M5 12a7 7 0 1 1 14 0 7 7 0 0 1-14 0Zm7-3.5A3.5 3.5 0 1 0 12 16a3.5 3.5 0 0 0 0-7Z" />
                                        </svg>
                                    </span>
                                    <span class="label">Start recording</span>
                                </button>
                                <button type="button" class="btn-feature button-with-icon" id="cameraBtn">
                                    <span class="icon" aria-hidden="true">
                                        <svg viewBox="0 0 24 24">
                                            <path
                                                d="M4.75 7A2.75 2.75 0 0 0 2 9.75v4.5A2.75 2.75 0 0 0 4.75 17h9.5A2.75 2.75 0 0 0 17 14.25v-1.55l2.87 1.53a1 1 0 0 0 1.47-.88V10.65a1 1 0 0 0-1.47-.88L17 11.3V9.75A2.75 2.75 0 0 0 14.25 7h-9.5ZM8 9.5a3 3 0 1 1 0 6 3 3 0 0 1 0-6Z" />
                                        </svg>
                                    </span>
